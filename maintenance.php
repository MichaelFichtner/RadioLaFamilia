...
echo "Powered by <a href='http://www.pimped-fusion.net'>Pimped-Fusion</a> &copy; 2009 - ".date("Y")."<br />\n";
echo "Powered by <a href='http://www.php-fusion.co.uk'>PHP-Fusion</a> &copy; 2003 - ".date("Y")."<br /><br />\n";
echo "</div>\n</td>\n</tr>\n</table>\n";

if (!iMEMBER) {
	echo "<div align='center'><br />\n";
	echo "<form name='loginform' method='post' action='".make_url(BASEDIR."index.php", "index", "", ".html")."'>\n"; // Pimped: Fix
