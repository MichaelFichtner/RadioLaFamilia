...
$_GET['rowstart'] = $_GET['page'] > 0 ? ($_GET['page']-1) * "10" : "0"; // Pimped
...
function search_navigation($rows) {
	...
	$navigation_result = "<div align='center' style='margin-top:5px;'>\n".pagination(true,$_GET['rowstart'], 10, ($site_search_count > 100 || search_globalarray("") ? 100 : $site_search_count), 3, FUSION_SELF."?stype=".$_GET['stype']."&amp;stext=".urlencode($_GET['stext'])."&amp;".$composevars)."\n</div>\n"; // Pimped
