...
define('L_NO', "no");
define('L_SAVE', "Save");
define('L_SELECTPLEASE', "- Select please -");

// Standard User Levels
define('L_PUBLIC', "Public");
	$locale['user0'] = "Public";
define('L_MEMBER', "Member");
	$locale['user1'] = "Member";
...
define('L_ONLYGUESTS', "only Guests");
	$locale['user4'] = "only Guests";
...
$locale['global_061'] = "Language"; // Pimped
$locale['global_062'] = "Display More Threads"; // Pimped
$locale['global_063'] = "Display Less Threads"; // Pimped
$locale['global_064'] = "Settings"; // Pimped
$locale['global_065'] = "Show only Threads with the language:"; // Pimped
$locale['global_066'] = "Save Settings"; // Pimped
$locale['global_067'] = " [resolved] "; // Pimped
// News & Articles
...
$locale['global_105'] = "Not a member yet?<br /><a href='".BASEDIR.make_url("register.php", "register", "", ".html")."' class='side'>Click here</a> to register."; // Pimped: make_url
$locale['global_106'] = "Forgotten your password?<br />Request a new one <a href='".BASEDIR.make_url("lostpassword.php", "lostpassword", "", ".html")."' class='side'>here</a>."; // Pimped: make_url
...
$locale['global_128'] = "Reported posts";
// Poll
...
[ <a href='".REDIRECT_TO."'>Or click here if you do not wish to wait</a> ]"; // Pimped
$locale['global_198'] = "<strong>Warning:</strong> setup.php detected, please delete it immediately.";
$locale['global_198b'] = "<strong>Warning:</strong> update.php detected, please delete it immediately."; // Pimped: added
...
$locale['global_301'] = "We are really sorry but this page cannot be displayed. Due to some circumstances no site theme can be found. If you are a Site Administrator, please use your FTP client to upload any theme designed for <em>Pimped-Fusion</em> to the <em>themes/</em> folder. After upload check in <em>Main Settings</em> to see if the selected theme was correctly uploaded to your <em>themes/</em> directory. Please note that the uploaded theme folder has to have the exact same name (including character case, which is important on Unix based servers) as chosen in <em>Main Settings</em> page.<br /><br />If you are regular member of this site, please contact the site\'s administrator via ".hide_email($settings['siteemail'])." e-mail and report this issue.";
...
$locale['global_412'] = "This account has been anonymized, probably because of inactivity.<br />
It cannot be restored.<br />
Contact any administrator for futher information.<br />";
...
$locale['flogins_100'] = "Someone tried to login in your account";
$locale['flogins_101'] = "Someone tried to login in your account.\nThere have been %s failed login attampts.\n";
$locale['flogins_102'] = "The login attempt took place on %s";
$locale['flogins_103'] = "The first login attempt took place on %s and the last login attempt on %s";

// Language Switcher
$locale['langswitch_100'] = "Languages";
