...
$locale['412'] = "Security Question not answered"; # Pimped
$locale['413'] = "Wrong answer of the Security Question"; # Pimped
$locale['414'] = "Wrong Security-ID. Please contact the administrator of this site"; # Pimped
// Email Message
...
Password: ".(isset($_POST['password1']) ? $_POST['password1'] : "")."\n\nNobody can read your password in plain text, even an administrator can not.\n\n
...
$locale['510'] = "Security Question:"; # Pimped
$locale['511'] = "Recaptcha Validation Code:"; # Pimped
// Validation Errors
$locale['550'] = "Please specify a user name.";
$locale['551'] = "Please specify a password.";
$locale['552'] = "Please specify an email address.";
$locale['553'] = "The reCAPTCHA wasn't entered correctly. Please Try Again."; # Pimped
$locale['554'] = "Recaptcha is enabled, but there was no input! Please Try Again."; # Pimped
?>