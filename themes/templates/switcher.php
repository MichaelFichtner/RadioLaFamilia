...
+----------------------------------------------------------------------------+
| Filename: themes/templates/switcher.php
| Version: Pimped Fusion v0.07.00
+----------------------------------------------------------------------------+
| based on PHP-Fusion CMS v7.01 by Nick Jones
| http://www.php-fusion.co.uk/
+----------------------------------------------------------------------------+
| Authors: Matonor, modified for PiF by slaughter
+----------------------------------------------------------------------------+
...
class Switcher{
	...
	// We are using this function in PiF for Colour-Switcher:
	function getCSSFile(){
		return $this->dir."/".$this->selected.".css";
	}
	
	// This function is used in PHP-Fusion 7:
	// not removed because of compatibility reasons, so it still can be used
