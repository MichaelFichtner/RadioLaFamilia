...
$result = dbquery("SELECT * FROM ".PR_DB_BEWERBUNG." WHERE pr_status='4' ORDER BY pr_id");

//Beginn Content
opentable("Bewerbung v".$version." &raquo; Gel&ouml;schte");

	if (count_bew("4") == "0"){ 
		echo "<center>Keine gel&ouml;schten Bewerbungen</center>"; 
	}else {
		$n="0";
