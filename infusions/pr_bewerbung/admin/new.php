...
$result = dbquery("SELECT * FROM ".PR_DB_BEWERBUNG." WHERE pr_status='1' ORDER BY pr_id");

opentable("Bewerbung v".$version." &raquo; Neue");

	if (count_bew("1") == "0"){ echo "<center>Keine neuen Bewerbungen</center>"; }
