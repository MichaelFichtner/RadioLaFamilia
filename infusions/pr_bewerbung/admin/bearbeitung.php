...
$result = dbquery("SELECT * FROM ".PR_DB_BEWERBUNG." WHERE pr_status='2' ORDER BY pr_id");

//Beginn Content
opentable("Bewerbung v".$version." &raquo; Bearbeitung");

	if (count_bew("2") == "0"){ echo "<center>Keine Bewerbungen in Bearbeitung</center>"; }
