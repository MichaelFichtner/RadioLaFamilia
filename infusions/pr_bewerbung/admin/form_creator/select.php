...
echo "<table width='100%'>
	...
	<tr>
		<td>Values: <img src='".INFUSIONS."pr_bewerbung/admin/images/qmark.png' onmouseover=\"return overlay(this, 'values_info', 'bottomleft');\" onmouseout=\"return overlayclose('values_info');\" style='vertical-align:middle;'/>
...
echo "<center><input type='hidden' name='type' value='select' /><input type='submit' value='Speichern' name='save_it' class='button' /></center>";
