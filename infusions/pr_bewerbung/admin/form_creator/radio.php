...
echo "<form name='radio' method='post'>";
...
echo "<table width='100%'>
	<tr>
		...
		<div id='name_info' class='infopopup'>Dies ist die elementare Angabe, sie beschreibt dem User was er in dieses Feld einf&uuml;gen soll, z.B. Benutzername, eMail usw.</div></td>
		<td><input type='text' name='desc' size='24' class='textbox'></td>
	</tr>
	<tr>
		<td>Values: 
		<img src='".INFUSIONS."pr_bewerbung/admin/images/qmark.png' onmouseover=\"return overlay(this, 'values_info', 'bottomleft');\" onmouseout=\"return overlayclose('values_info');\" style='vertical-align:middle;'/>
		<div id='values_info' class='infopopup'>Dies gibt die Anzahl der Auswahlm&ouml;glichkeiten an, welche Sie im n&auml;chsten Schritt festlegen.</div></td>
		<td><select name='values' class='textbox'>
			<option value=''> -- </option>";
			for($i=1; $i <= 15; $i++){
...
echo "<center><input type='hidden' name='type' value='radio' /><input type='submit' value='Speichern' name='save_it' class='button' /></center>";
