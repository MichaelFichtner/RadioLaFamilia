...
<div id="chatroom_userlist">
  <div id="chatroom_userlist_contents">
    ...
    <div id="chatroom_userlist_list">
		<!-- Radiostatus -->
		 <iframe src="http://radio-la-familia.de/infusions/gr_radiostatus_panel/gr_radiostatus_chat.php" scrolling="no" frameborder="0" style="width:200px; height:250px;"></iframe>
		<hr />
		<center>
			<b>User im Chat</b>
		</center><!-- Radiostatus END-->
