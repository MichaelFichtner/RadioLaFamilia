...
if (isset($_POST['savesettings'])) {
	...
	if (check_admin_pass(isset($_POST['admin_password']) ? stripinput($_POST['admin_password']) : "")) {
		if(!set_mainsetting('download_max_b', isnum($_POST['download_max_b']) ? $_POST['download_max_b'] : "150000")) { $error = 1; }
		if(!set_mainsetting('download_types', stripinput($_POST['download_types']))) { $error = 1; }
