...
$lang['L_ACTUALLY_INSERTED_RECORDS']="Es wurden bisher <b>%s</b> Datensätze erfolgreich eingetragen.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="Es wurden bisher <b>%s</b> von <b>%s</b> Datensätzen erfolgreich eingetragen.";
...
$lang['L_ANALYZING_TABLE']="Momentan werden Daten der Tabelle '<b>%s</b>' analysiert.";
...
$lang['L_BACKUP_TABLE_DONE']="Sicherung der Tabelle `%s` abgeschlossen. %s Datensätze wurden gespeichert.";
...
$lang['L_CONFIRM_DELETE_TABLES']="Sollen die gewählten Tabellen wirklich gelöscht werden?";
$lang['L_CONFIRM_DROP_DATABASES']="Soll/en die gewählte/n Datenbank/en wirklich gelöscht werden?

Achtung: alle Daten gehen unwiderruflich verloren! Legen Sie sicherheitshalber vorher eine Sicherung der Daten an.";
$lang['L_CONFIRM_RECIPIENT_DELETE']="Soll der Empfänger \"%s\" wirklich entfernt werden?";
$lang['L_CONFIRM_TRUNCATE_DATABASES']="Soll/en die gewählte/n Datenbank/en wirklich geleert werden?

Achtung: alle Tabellen gehen unwiderruflich verloren! Legen Sie sicherheitshalber vorher eine Sicherung der Daten an.";
$lang['L_CONFIRM_TRUNCATE_TABLES']="Sollen die gewählten Tabellen wirklich geleert werden?";
$lang['L_CONNECT']="verbinden";
$lang['L_CONNECTIONPARS']="Verbindungsparameter";
$lang['L_CONNECTTOMYSQL']="zu MySQL verbinden";
$lang['L_CONTINUE_MULTIPART_RESTORE']="Multipart-Wiederherstellung mit nächster Datei '%s' fortfahren .";
...
$lang['L_CREATE_TABLE_SAVED']="Definition der Tabelle `%s` gespeichert.";
...
$lang['L_DATASIZE_INFO']="Dies ist die Größe der Datensätze - nicht die Größe der Sicherungsdatei";
$lang['L_DAY']="Tag";
$lang['L_DAYS']="Tage";
$lang['L_DB']="Datenbank";
...
$lang['L_DUMP_NOTABLES']="Es konnten keine Tabellen in der Datenbank `%s` gefunden werden.";
$lang['L_DUMP_OF_DB_FINISHED']="Sicherung der Datenbank '%s' abgeschlossen";
...
$lang['L_ERROR_MULTIPART_RESTORE']="Multipart-Wiederherstellung: Konnte die nächste Datei '%s' nicht finden!";
...
$lang['L_FILE_SAVED_SUCCESSFULLY']="Die Datei wurde erfolgreich gespeichert.";
$lang['L_FILE_SAVED_UNSUCCESSFULLY']="Die Datei konnte nicht gespeichert werden!";
$lang['L_FILE_UPLOAD_SUCCESSFULL']="Die Datei '%s' wurde erfolgreich hochgeladen.";
...
$lang['L_FM_ASKDELETE3']="Möchten Sie das automatische Löschen nach den eingestellten Regeln jetzt ausführen?";
...
$lang['L_FM_AUTODEL1']="Automatisches Löschen: Folgende Dateien wurden aufgrund der maximalen Dateianzahl gelöscht:";
...
$lang['L_FM_DELETEAUTO']="Automatisches löschen manuell ausführen";
...
$lang['L_FTP_CONFIRM_DELETE']="Soll diese FTP-Verbindung wirklich gelöscht werden?";
...
$lang['L_FTP_CONNECTION_ERROR']="Die Verbindung zum Server '%s' über Port %s konnte nicht aufgebaut werden";
$lang['L_FTP_CONNECTION_SUCCESS']="Die Verbindung zum Server '%s' über Port %s wurde erfolgreich hergestellt";
$lang['L_FTP_DIR']="Upload-Ordner";
$lang['L_FTP_FILE_TRANSFER_ERROR']="Die Übertragung der Datei '%s' war fehlerhaft";
$lang['L_FTP_FILE_TRANSFER_SUCCESS']="Die Datei '%s' wurde erfolgreich übertragen";
$lang['L_FTP_LOGIN_ERROR']="Die Anmeldung als Benutzer '%s' wurde abgelehnt";
$lang['L_FTP_LOGIN_SUCCESS']="Die Anmeldung als Benutzer '%s' war erfolgreich";
...
$lang['L_FTP_PASV_ERROR']="Der Wechsel in den passiven FTP-Modus war nicht erfolgreich";
$lang['L_FTP_PASV_SUCCESS']="Der Wechsel in den passiven FTP-Modus war erfolgreich";
...
$lang['L_HTACC_EXISTS']="Es besteht bereits ein Verzeichnisschutz. Wenn Sie einen neuen erstellen, wird der alte überschrieben!";
...
$lang['L_HTACC_WARNING']="Achtung! Die .htaccess hat eine direkte Auswirkung auf den Browser.<br />Bei falscher Anwendung sind die Seiten nicht mehr erreichbar.";
...
$lang['L_INFO_FSOCKOPEN_DISABLED']="Auf diesem Server ist die PHP-Funktion fsockopen() leider per Serverkonfiguration deaktiviert, weshalb das automatischeac Herunterladen der Sprachpakete nicht ausgeführt werden kann. Sie können die gewünschten Pakete jedoch manuell herunterladen, entpacken und mit Ihrem FTP-Programm in den Unterordner \"language\" Ihrer MySQLDumper-Installation speichern. Anschließend stehen Ihnen diese hier zur Auswahl zur Verfügung.";
...
$lang['L_MULTIDUMP_FINISHED']="Es wurden <b>%d</b> Datenbanken gesichert";
...
$lang['L_NEXT_AUTO_INCREMENT']="Nächster automatischer Index";
...
$lang['L_OPTIMIZE_TABLE_ERR']="Fehler beim Optimieren der Tabelle `%s`.";
$lang['L_OPTIMIZE_TABLE_SUCC']="Die Tabelle `%s` wurde erfolgreich optimiert.";
...
$lang['L_RECORDS_INSERTED']="<b>%s</b> Datensätze wurden eingetragen.";
$lang['L_RECORDS_PER_PAGECALL']="Datensätze pro Seitenaufruf";
$lang['L_REFRESHTIME']="Aktualisierungsintervall";
$lang['L_REFRESHTIME_PROCESSLIST']="Aktualisierungsintervall der Prozessliste";
...
$lang['L_RESTORE_DB_COMPLETE_IN']="Wiederherstellung der Datenbank '%s' in %s abgeschlossen.";
...
$lang['L_SAVING_DATA_TO_FILE']="Speichere Daten der Datenbank '%s' in der Datei '%s'";
$lang['L_SAVING_DATA_TO_MULTIPART_FILE']="Maximale Dateigröße erreicht: Fortfahren mit Datei '%s'";
...
$lang['L_START_RESTORE_DB_FILE']="Beginne Wiederherstellung der Datenbank '%s' aus Datei '%s'.";
...
$lang['L_TABLE_CREATE_SUCC']="Die Tabelle '%s' wurde erfolgreich angelegt.";
