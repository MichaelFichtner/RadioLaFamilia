...
$lang['L_ASKDBCOPY']="Do you  want to copy database `%s` to
 database `%s`?";
$lang['L_ASKDBDELETE']="Do you want to delete the Database `%s`
 with the content?";
...
$lang['L_ASKTABLEEMPTYKEYS']="Should the table `%s` be emptied and the
 Indices reset?";
...
$lang['L_CHOOSE_CHARSET']="MySQLDumper couldn't detect the encoding
 of the backup file automatically.
<br
 />You must choose the charset with which
 this backup was saved.
<br />If you
 discover any problems with some
 characters after restoring, you can
 repeat the backup-progress and then
 choose another character set.
<br />Good
 luck. ;)";
...
$lang['L_CONFIRM_DROP_DATABASES']="Should the selected databases really be
 deleted?

Attention: all data will be
 deleted! Maybe you should create a
 backup first.";
...
$lang['L_CONFIRM_TRUNCATE_DATABASES']="Should all tables of the selected
 databases really be deleted?

Attention:
 all data will be deleted! Maybe you want
...
$lang['L_DB_SELECT_ERROR']="<br />Error:<br />Selection of database
 <b>";
...
$lang['L_DUMP']="Backup";
$lang['L_DUMP_ENDERGEBNIS']="The file contains <b>%s</b> tables with
 <b>%s</b> records.<br />";
...
$lang['L_EMAILBODY_ATTACH']="The Attachment contains the backup of
 ...
 Database `%s`
<br /><br />Following File
 was created:<br /><br />%s <br /><br
 />Kind regards<br /><br />MySQLDumper<br
 />";
$lang['L_EMAILBODY_FOOTER']="`<br /><br />Kind regards<br /><br
 />MySQLDumper<br />";
$lang['L_EMAILBODY_MP_ATTACH']="A Multipart Backup was created.<br />The
 Backup files are attached to separate
 emails.<br />Backup of Database `%s`
<br
 /><br />Following Files were created:<br
 /><br />%s <br /><br />Kind regards<br
 /><br />MySQLDumper<br />";
$lang['L_EMAILBODY_MP_NOATTACH']="A Multipart Backup was created.<br />The
 Backup files are not attached to this
 email!<br />Backup of Database `%s`
<br
 /><br />Following Files were created:<br
 /><br />%s
<br /><br />Kind regards<br
 /><br />MySQLDumper<br />";
$lang['L_EMAILBODY_NOATTACH']="Files are not attached to this email!<br
...
$lang['L_EMAILBODY_TOOBIG']="The Backup file exceeded the maximum
 size of %s and was not attached to this
 email.<br />Backup of Database `%s`
<br
 /><br />Following File was created:<br
 /><br />%s
<br /><br />Kind regards<br
 /><br />MySQLDumper<br />";
...
$lang['L_ENTER_DB_INFO']="First click the button \"Connect to
 ...
 detected you need to provide a database
 name here.";
$lang['L_ENTRY']="Entry";
$lang['L_ERROR']="Error";
...
$lang['L_FATAL_ERROR_DUMP']="Fatal error: the CREATE-Statement of
 table '%s' in database '%s' couldn't be
 read!";
...
$lang['L_FILE_UPLOAD_SUCCESSFULL']="The file '%s' was uploaded successfully.";
...
$lang['L_FTP_CONNECTION_ERROR']="The connection to server '%s' using port
 %s couldn't be established";
$lang['L_FTP_CONNECTION_SUCCESS']="The connection to server '%s' using port
 %s was established successfully";
...
$lang['L_HTACC_EXISTS']="It already exists an directory
 protection. If you create a new one, the
...
$lang['L_INFO_FSOCKOPEN_DISABLED']="On this server the PHP command
 fsockopen() is disabled by the server's
 configuration. Because of this the
 automatic download of language packs is
 not possible. To bypass this, you can
 download packages manually, extract them
 locally and upload them to the directory
 \"language\" of your MySQLDumper
 installation. Afterwards the new
 language pack is available on this site.";
...
Your
 ...
 the MySQL-Server.<br />
But MySQLDumper
 was not able to find any database.<br
 />
The automatic detection via script is
 blocked on some servers.<br />
You must
 enter your database name manually after
 the installation is finished.
Click on
 \"configuration\" \"Connection Parameter
 - display\" and enter the database name
 there.";
$lang['L_NO_DB_SELECTED']="No database selected.";
$lang['L_NO_ENTRIES']="Table \"<b>%s</b>\" is empty and doesn't
 have any entry.";
...
$lang['L_PERLOUTPUT2']="URL for the browser or for external Cron
 job";
...
$lang['L_SQL_DBCOPY']="The Content of Database `%s` was copied
 in Database `%s`.";
...
$lang['L_SQL_TCOPY']="Table `%s` was copied with data in Table
 `%s`.";
...
$lang['L_SQL_WARNING']="The execution of SQL Statements can
 manipulate data. TAKE CARE! The Authors
 don't accept any liability for damaged
 or lost data.";
