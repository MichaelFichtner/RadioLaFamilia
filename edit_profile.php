...
echo "<form name='inputform' method='post' action='".make_url("edit_profile.php", "edit_profile", "", ".html")."' enctype='multipart/form-data'>\n";
...
echo "<td class='tbl'><input type='text' name='user_name' value='".$user_data['user_name']."' maxlength='30' class='textbox' ".($settings['allowtochange_username'] ? "" : "readonly='readonly' ")."style='width:200px;' /></td>\n";
echo "</tr>\n<tr>\n";
...
echo "</tr>\n";
if (!$user_data['user_avatar'] && !$settings['extern_avatar_upload']) {
	echo "<tr>\n<td valign='top' class='tbl' align='center' colspan='2'><img src='".IMAGES_AVA."noavatar.jpg' alt='' /><br />".$locale['u017']."</td></tr>\n";
	echo "<tr>\n";
	...
	echo "</tr>\n";
} elseif (!$user_data['user_avatar']) {
	echo "<tr>\n<td valign='top' class='tbl' align='center' colspan='2'><img src='".IMAGES_AVA."noavatar.jpg' alt='' /><br />".$locale['u017']."</td></tr>\n";
	echo "<tr>\n";
	echo "<td valign='top' class='tbl'>".$locale['u018'].":</td>\n";
	echo "<td class='tbl'><input type='file' name='user_avatar' class='textbox' style='width:200px;' /><br />\n";
	echo "<span class='small2'>".$locale['u011']."</span><br />\n";
	echo "<span class='small2'>".sprintf($locale['u012'], parsebytesize($settings['avatar_filesize']), $settings['avatar_width'], $settings['avatar_height'])."</span></td>\n";
	echo "</tr>\n";
	echo "<tr>\n";
	echo "<td valign='top' class='tbl'>".$locale['u015'].": </td>\n";
	echo "<td valign='top' class='tbl'><input type='text' name='user_avatarnet' value='http://www.' class='textbox' style='width:200px;'><br />\n";
	echo "<span class='small2'>".$locale['u016']."</span><br /><br /></td>\n";
	echo "</tr>\n";
} else {
	echo "<tr>\n";
	echo "<td valign='top' class='tbl'>".$locale['u010'].":</td>\n";
	echo "<td class='tbl'><img src='".IMAGES_AVA.$user_data['user_avatar']."' alt='".$locale['u010']."' /><br />\n";
	...
	echo "</tr>\n";
		...
		$profile_method = "input"; $icu = 0; $user_cats = array(); $user_fields = array(); $ob_active = false;
		$result2 = dbquery(
